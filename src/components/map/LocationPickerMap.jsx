...
export default function LocationPickerMap({ position, onChange, height = 'h-56' }) {
  ...
  return (
    <div className={`relative rounded-[24px] overflow-hidden border-2 border-slate-200 ${height}`}>
      ...
      <span className="absolute bottom-3 left-3 z-[500] text-[10px] font-bold text-slate-800 bg-white/90 px-2 py-1 rounded-lg shadow-sm pointer-events-none">
