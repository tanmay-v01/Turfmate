...
export default function BookingSuccessModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm animate-fade-in">
      <div className="w-full max-w-md bg-white/5 rounded-3xl shadow-2xl overflow-hidden animate-pop">
        <div className="bg-gradient-to-br from-brand-grassPale to-white px-5 pt-5 pb-4 border-b border-white/10">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-wider text-lime-400">Payment successful</p>
                <h2 className="text-lg font-display font-extrabold text-white">Your slot is booked!</h2>
              </div>
            </div>
            <button
              type="button"
        ...
        <div className="p-5 space-y-4">
          <div className="rounded-2xl border border-green-100 bg-green-50/80 p-4">
            ...
            <h3 className="font-bold text-white mt-2">{data.turfName}</h3>
          ...
          <div className="flex flex-col items-center p-4 bg-white/5 border border-white/10 rounded-2xl">
          ...
          <button
            type="button"
            onClick={() => app.setBookingSuccessData(null)}
            className="w-full py-2.5 text-sm font-bold text-slate-500 hover:text-white transition"
          >
            Done
          </button>
        </div>
