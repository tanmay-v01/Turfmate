      ...
      <div className="bg-white border border-brand-grassLight rounded-2xl shadow-lg p-4 flex items-start gap-3">
        <div className="w-10 h-10 rounded-xl bg-brand-grassPale flex items-center justify-center shrink-0">
          {isAndroidInstall ? (
            ...
            <Share className="w-5 h-5 text-brand-grassDeep" />
          )}
        </div>
        <div className="flex-1 min-w-0">
          ...
          {isAndroidInstall ? (
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Tap <span className="font-bold text-brand-forest">Share</span> in Safari, then{' '}
              <span className="font-bold text-brand-forest">Add to Home Screen</span>.
            </p>
          )}
        </div>
