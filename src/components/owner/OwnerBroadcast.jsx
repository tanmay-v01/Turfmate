  ...
  return (
    <div className="p-4 lg:p-8 animate-fade-in max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-display font-extrabold text-slate-800">Community Broadcasts</h2>
        ...
        <div className="flex gap-2">
          <div className="bg-white border border-slate-200 px-3 py-1.5 rounded-xl text-center shadow-sm">
            ...
            <span className="text-sm font-black text-slate-800">4,200</span>
          </div>
          <div className="bg-white border border-slate-200 px-3 py-1.5 rounded-xl text-center shadow-sm">
            <span className="text-[10px] font-bold text-slate-400 block uppercase">Conversions</span>
            <span className="text-sm font-black text-slate-800">18 bookings</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <form onSubmit={handlePublish} className="lg:col-span-7 bg-white border border-slate-200 p-6 rounded-3xl shadow-sm space-y-4">
          <div className="flex items-center gap-3 pb-3 border-b border-slate-200">
            ...
            <div>
              <h3 className="font-extrabold text-slate-800 text-sm">Campaign Builder</h3>
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar pt-6 pb-4 px-2 space-y-3">
              ...
              <div className={`rounded-2xl bg-white overflow-hidden shadow-sm border text-left ${
                ...
                <div className="relative h-20 bg-slate-200">
                  ...
                  <span className="absolute bottom-1 left-2 px-1.5 py-0.5 rounded-full bg-white/90 text-[8px] font-bold text-slate-800">
                ...
                <div className="p-3.5 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        <span className="font-extrabold text-[10px] text-slate-800 truncate max-w-[120px]">{targetTurfObj?.name || 'Venue'}</span>
                  ...
                  {/* Headline & message */}
                  <div className="space-y-1 bg-slate-50/50 p-2 rounded-xl border border-slate-200">
                  ...
                  {/* Action CTA */}
                  <button type="button" className="w-full py-2 bg-brand-forest text-slate-800 rounded-lg text-[9px] font-black uppercase flex items-center justify-center gap-1">
                    <span>{cta}</span>
                  </button>
                </div>
              </div>
      ...
      <div className="border-t border-slate-200 pt-6">
        <h3 className="font-extrabold text-slate-800 text-sm mb-4">Active Campaigns</h3>
        {loadingCampaigns ? (
                ...
                <div key={ann.id} className={`bg-white border p-4 rounded-2xl flex items-start gap-3 relative ${
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <p className="font-bold text-slate-800 text-sm truncate">{ann.turfName || 'Venue Announcement'}</p>
