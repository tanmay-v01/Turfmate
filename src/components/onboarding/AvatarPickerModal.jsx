...
export default function AvatarPickerModal() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-0 sm:p-4 animate-fade-in">
      ...
      <div className="relative w-full sm:max-w-md bg-white/5 rounded-t-[28px] sm:rounded-[28px] shadow-premium border border-white/10 p-5 sm:p-6 max-h-[90vh] overflow-y-auto animate-slide-up">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h3 className="font-display font-extrabold text-lg text-white lowercase">choose avatar</h3>
        ...
        <div className="flex justify-center mb-4">
          <img
            ...
            alt=""
            className="w-20 h-20 rounded-[24px] border-4 border-brand-grassFresh/50 bg-lime-400/10 shadow-soft object-cover"
          />
        </div>
