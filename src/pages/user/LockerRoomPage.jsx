  ...
  return (
    <div className="animate-fade-up pb-24">
      ...
      <div className="glass-card p-4 mb-5">
        <p className="text-sm font-bold text-brand-forest flex items-center gap-2">
      ...
      {feed.length === 0 ? (
        <div className="glass-card p-10 text-center">
          ...
          <p className="font-bold text-brand-forest">Nothing here yet</p>
              ...
              >
                {(ann.turfImage || app.turfs.find(t => t.id === ann.turfId)) && (
                  <div className="relative h-32">
                    ...
                    <span className="absolute bottom-2 left-3 px-2 py-0.5 rounded-full bg-white/90 text-[10px] font-bold text-brand-forest">
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="font-display font-extrabold text-brand-forest text-sm">{ann.hostName}</span>
                        {ann.isAdminAnnouncement ? (
                ...
                {ann.text && (
                  <p className="mt-4 text-sm text-slate-600 bg-slate-50 rounded-2xl p-3 border border-slate-100 leading-relaxed">
                    {ann.text}
                  </p>
                )}
                ...
                {ann.turfName && (
                  <div className="mt-4 grid sm:grid-cols-2 gap-3 text-sm">
                    <div className="glass-card !rounded-2xl p-3 !shadow-none">
                      ...
                      <p className="font-bold text-brand-forest mt-0.5 truncate">{ann.sportLabel} @ {ann.turfName}</p>
                    </div>
                    <div className="glass-card !rounded-2xl p-3 !shadow-none">
                  ...
                  {ann.isAdminAnnouncement ? (
                    ...
                    <>
                      <div>
                        ...
                        <p className="font-display font-extrabold text-brand-forest">₹{ann.costPerHead}/head</p>
                      </div>
                      {ann.status === 'filled' ? (
                    ...
                    <>
                      ...
                      <button onClick={() => openTurf(ann.turfId)} className="text-xs font-bold text-brand-grassDeep hover:underline">
                        view turf →
                      </button>
                    </>
                  )}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-end sm:items-center z-50">
          <div className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl p-5 pb-8 animate-slide-up">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-display font-extrabold text-brand-forest">create post</h3>
