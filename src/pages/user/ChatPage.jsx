          ...
          <>
            ...
            {pastGames.length > 0 && (
              <button
                ...
                className="mt-4 flex items-center gap-2 text-xs font-bold text-slate-500 hover:text-brand-forest"
              >
  ...
  const roomPanel = activeChat ? (
    ...
    <div className="tm-chat-room-placeholder hidden lg:flex">
      <div className="text-center max-w-xs px-6">
        <div className="w-14 h-14 rounded-2xl tm-icon-accent-violet flex items-center justify-center mx-auto mb-4">
          <MessageCircle className="w-7 h-7" />
        </div>
        <p className="font-display font-extrabold text-brand-forest lowercase text-lg">pick a conversation</p>
