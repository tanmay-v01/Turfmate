...
export default function PlayerRadarPage() {
  ...
  const getTierBadge = (tier) => {
    ...
    if (t === 'silver') return 'bg-slate-100 text-slate-700 border-slate-200 font-bold';
          ...
          {isLoading ? (
            ...
            players.map((player) => {
              ...
              return (
                ...
                >
                  <img src={player.avatar_url || `https://api.dicebear.com/7.x/adventurer/svg?seed=${player.username}`} alt="" className="w-12 h-12 rounded-full border-2 border-slate-200 bg-slate-50 shrink-0" />
                  
                  <div className="flex-grow min-w-0">
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <h4 className="font-extrabold text-sm text-slate-700 truncate">{player.username}</h4>
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-4">
          <div className="bg-white w-full max-w-sm rounded-3xl p-5 relative animate-slide-up shadow-2xl">
            ...
            <div className="text-center mt-2">
              ...
              <h2 className="text-xl font-black text-slate-800 mt-3 font-display">{selectedPlayer.username}</h2>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              ...
              <div className="bg-slate-50 rounded-xl p-3 text-center border border-slate-200">
                ...
                <span className="text-2xl font-black text-slate-700">{selectedPlayer.total_games_played}</span>
              </div>
            </div>
            ...
            <div className="mt-4 border-t border-slate-200 pt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {Object.entries(parseJson(selectedPlayer.skill_tags, {})).map(([sport, skill]) => (
                  <span key={sport} className="px-3 py-1 bg-emerald-50 text-slate-800 text-[10px] font-bold rounded-lg capitalize border border-brand-primary/30">
                    {sport}: {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="mt-4 border-t border-slate-200 pt-4">
               <div className="flex justify-between items-center mb-2">
                 ...
                 <button 
                   ...
                   className="text-[9px] font-bold text-emerald-600 border border-brand-grassFresh px-2 py-0.5 rounded hover:bg-emerald-50 transition"
                 >
               ...
               <div className="space-y-2 text-left">
                 <div className="bg-slate-50 rounded-lg p-2 border border-slate-200">
                   <div className="flex items-center justify-between mb-1">
                     <span className="font-bold text-[10px] text-slate-800">Suraj K.</span>
                 ...
                 <div className="bg-slate-50 rounded-lg p-2 border border-slate-200">
                   <div className="flex items-center justify-between mb-1">
                     <span className="font-bold text-[10px] text-slate-800">Anon</span>
