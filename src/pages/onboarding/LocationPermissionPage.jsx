      ...
      footer={
        <div className="space-y-3">
          ...
          <button
            ...
            disabled={app.isLocating}
            className="w-full py-3 text-sm font-bold text-brand-muted hover:text-brand-forest transition disabled:opacity-50"
          >
    ...
    >
      <div className="flex justify-center py-8">
        <div className="relative">
          <div className="w-32 h-32 rounded-full tm-icon-accent-sky border-2 border-sky-200 flex items-center justify-center">
            <MapPin className="w-14 h-14 text-brand-grassDeep animate-bounce" />
          </div>
      ...
      <div className="tm-card p-4 text-center space-y-1">
        ...
        <p className="text-[10px] text-slate-400">
          default radius <span className="text-brand-grassDeep font-bold">10 km</span> · refresh anytime on the map tab
        </p>
      </div>
    </OnboardingShell>
  );
